        ...
        <section class="main__basket-info">
          ...
          <div class="main__basket-info-item order-info">
            ...
            <div class="main__basket-info-item-product-count">
              <div class="main__basket-info-item-product" data-count="count-block">
                <div class="main__basket-info-item-product-img">
                  <img src="img/image-card-item1.png" alt="product image">
                </div>
                ...
                <button class="main__product-details-about-item-basket-flex-count main__basket-info-item-product-calc bg-white" data-name="count-1">
                  <span class="minus" data-name="count-1">-</span><span class="result" data-name="count-1">1 </span><span class="plus" data-name="count-1">+</span>
                </button>
              ...
              <div class="main__basket-info-item-product" data-count="count-block">
                <div class="main__basket-info-item-product-img">
                  <img src="img/image-card-item2.png" alt="product image">
                </div>
                <p class="main__basket-info-item-product-name">
                  Шпагат джутовый Сибшнур 500 м
                </p>
                <button class="main__product-details-about-item-basket-flex-count bg-white main__basket-info-item-product-calc" data-name="count-2">
                  <span class="minus" data-name="count-2">-</span><span data-name="count-2" class="result">1</span><span class="plus" data-name="count-2">+</span>
                </button>
                <p class="main__basket-info-item-product-price" data-price="basket-item-price">
                  385 ₽
                </p>
              ...
              <div class="main__basket-info-item-product" data-count="count-block">
                <div class="main__basket-info-item-product-img">
                  <img src="img/image-card-item7.png" alt="product image">
                </div>
                <p class="main__basket-info-item-product-name">
                  Пряжа трикотажная Arachna «Слинг Принт»
                </p>

                <button class="main__product-details-about-item-basket-flex-count bg-white main__basket-info-item-product-calc" data-name="count-3">
                  <span class="minus" data-name="count-3">-</span><span class="result" data-name="count-3">1</span><span class="plus" data-name="count-3">+</span>
                </button>
